...
2. **HTTPS/PWA:** wait for service worker install (Application > Service Workers > `msc-cyber-lock37`)
...
## Technical status (lock37)

- Deck counts: ACIT4050=94, ACIT4280=175, ACIT4100=123, computer-basics=28, fellesjam-general=26 (Fellesjam pool=446)
