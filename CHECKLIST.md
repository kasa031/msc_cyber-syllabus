...
## Technical status (lock25)

- Mobile: viewport-fit, safe-area, touch targets ~44px, skip link, hash deep-links (`#4050`, `#practice`, `#nist`, `#killchain`, `#4280`, `#4100`, `#pc`)
...
- SW: network-first quiz payloads + body validation; cache name `msc-cyber-lock25`
...
- Deck counts: ACIT4050=85, ACIT4280=118, ACIT4100=102, computer-basics=28
