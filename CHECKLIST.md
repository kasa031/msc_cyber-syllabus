...
- SW: network-first quiz payloads + body validation; cache name `msc-cyber-lock12`
- Quiz grades: Easy is outline turquoise (distinct from filled Good)
- Deck counts: ACIT4050=65, ACIT4280=118, ACIT4100=32, computer-basics=28
