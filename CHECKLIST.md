...
2. **HTTPS/PWA:** wait for service worker install (Application > Service Workers > `msc-cyber-lock110`)
...
## Technical status (lock110)

- Deck counts: ACIT4050=207, ACIT4280=209, ACIT4100=309, computer-basics=28, fellesjam-general=26 (Fellesjam pool ~779 unique)
