...
2. **HTTPS/PWA:** wait for service worker install (Application > Service Workers > `msc-cyber-lock42`)
...
6. Fellesjam pool = merged cards from all five source decks (502 cards)
...
- Deck counts: ACIT4050=163, ACIT4280=200, ACIT4100=131, computer-basics=28, fellesjam-general=26 (Fellesjam pool=548)
